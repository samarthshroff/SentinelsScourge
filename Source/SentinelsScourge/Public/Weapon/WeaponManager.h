 ...
 */
UCLASS()
class SENTINELSSCOURGE_API UWeaponManager : public UObject
{
	GENERATED_BODY()
...
public:
	...
	void SetWeaponSpecHandleAndAttributeSet(const FGameplayTag &WeaponTag, FGameplayAbilitySpecHandle &Handle, TObjectPtr<UWeaponAttributeSet> AttributeSet);
};
