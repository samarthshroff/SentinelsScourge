...
#include "SentinelsScourge/Public/Player/PlayerCharacterController.h"
...
void APlayerCharacterController::AutoRun()
{
	...
	const FRotator SmoothRotation = FMath::RInterpTo(ControlledPawn->GetActorRotation(), Direction.Rotation(), GetWorld()->GetDeltaSeconds(), 10.0f);
