...
void AVSProjectile::OnSphereOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor,
...
void AVSProjectile::BeginPlay()
{
	...
	Sphere->OnComponentBeginOverlap.AddDynamic(this, &AVSProjectile::OnSphereOverlap);
